...
### Overview
Build an image compression tool that recursively subdivides an image into quadrants, merging regions that are visually similar. This demonstrates divide-and-conquer at the pixel level.
